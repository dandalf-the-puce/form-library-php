...
/**
 * Class for describing how money values should be displayed
 * 
 ...
 */
class CurrencyDisplay implements JsonSerializable
{
    public const DEFAULT_VALUE = 'code';
    ...
    public function __construct(string $value = self::DEFAULT_VALUE)
    {
        if (!self::isValid($value)) {
            throw new InvalidArgumentException("Unknown currency display value: $value");
        }
