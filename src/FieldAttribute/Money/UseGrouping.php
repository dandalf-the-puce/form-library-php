...
/**
 * Class for describing how to use group separators for money values
 * 
 * @link https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Intl/NumberFormat/NumberFormat#usegrouping
 */
class UseGrouping implements JsonSerializable
{
    public const DEFAULT_VALUE = 'min2';
    ...
    public function __construct(string $value = self::DEFAULT_VALUE)
    {
        if (!self::isValid($value)) {
            throw new InvalidArgumentException("Unknown use grouping value: $value");
        }
